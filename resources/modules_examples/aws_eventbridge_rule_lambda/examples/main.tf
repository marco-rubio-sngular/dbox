...
module "sngular_mod_aws_cloudwatch_metric_alarm_metric" {
  source                 = "../module/"
...
output "sngular_mod_aws_cloudwatch_metric_alarm_metric_configuration_data_output" {
  value = local.configuration_data
}

output "sngular_mod_aws_cloudwatch_metric_alarm_metric_environment_data_output" {
